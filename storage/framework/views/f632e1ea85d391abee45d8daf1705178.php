...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-5">
        <div class="bg-white shadow-md rounded-lg p-6 transition-transform transform hover:scale-105 duration-300 ease-in-out">
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Welkom op je dashboard, <?php echo e(Auth::user()->name); ?>!</h1>
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-6">
                <img src="<?php echo e(asset('images/concert-4768496_960_720.jpg')); ?>" alt="Busreis" class="rounded-lg shadow-md w-full h-auto">
            </div>
        ...
        <div class="mt-12 bg-gray-50 p-6 rounded-lg shadow-md flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2" style="margin-top: 2%"> <!-- 50% breedte voor de afbeelding -->
                <img src="<?php echo e(asset('images/istockphoto-1913125761-1024x1024.jpg')); ?>" alt="Partybussen" class="rounded-lg shadow-md w-full h-auto">
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kadri\Desktop\festival1\resources\views/dashboard.blade.php ENDPATH**/ ?>