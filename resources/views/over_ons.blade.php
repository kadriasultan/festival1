@extends('layouts.app') <!-- Zorg ervoor dat dit de juiste layout is -->
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2"> <!-- Formulier sectie -->
                <form method="POST" action="{{ route('contact.submit') }}">
                    ...
                    <button type="submit" class="w-full bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-300">Verstuur</button>
                </form>
