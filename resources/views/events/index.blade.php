...
<div class="container mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
    ...
    <ul id="eventList">
        <li class="event-item mb-4 p-4 border border-gray-300 rounded bg-red-50">
            ...
            <div class="mt-4">
                <a href="{{ route('reserve', ['slug' => 'rotterdam-rave-kick-off-2025']) }}" style="background: #c94a39; color: white;" class="px-4 py-2 rounded inline-block">Reserve</a>
            </div>
        </li>
        ...
        <li class="event-item mb-4 p-4 border border-gray-300 rounded bg-red-50">
            ...
            <div class="mt-4">
                <a href="{{ route('reserve', ['slug' => 'verknipt-ziggo-dome-2025']) }}" style="background: #c94a39; color: white;" class="px-4 py-2 rounded inline-block">Reserve</a>
            </div>
        </li>
        ...
        <li class="event-item mb-4 p-4 border border-gray-300 rounded bg-red-50">
            ...
            <div class="mt-4">
                <a href="{{ route('reserve', ['slug' => 'karnaval-festival-zaterdag-2025']) }}" style="background: #c94a39; color: white;" class="px-4 py-2 rounded inline-block">Reserve</a>
            </div>
        </li>
        ...
        <li class="event-item mb-4 p-4 border border-gray-300 rounded bg-red-50">
            ...
            <div class="mt-4">
                <a href="{{ route('reserve', ['slug' => 'karnaval-festival-zondag-2025']) }}" style="background: #c94a39; color: white;" class="px-4 py-2 rounded inline-block">Reserve</a>
            </div>
        </li>
